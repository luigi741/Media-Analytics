...
app.get('/tweets', (req, res) => {
	...
	const twitterAPI = `https://api.twitter.com/1.1/search/tweets.json?q=3%23${req.query.keyword}&result_type=popular&tweet_mode=extended&lang=en`;
	//%20-filter%3Aretweets
	var options = {
		url: twitterAPI,
		headers: {
